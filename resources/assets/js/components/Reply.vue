<template>
    <div>
            ...
            <div class="panel-heading">
                <div class="level">
                    ...
                    <div v-if="canUpdate" class="buttons-block">
                        <button class="btn btn-xs btn-warning" @click="edit = true">Edit</button>
        ...
        <div v-else>
            ...
            <button class="btn btn-xs btn-success" @click="onUpdate">Update</button>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            canUpdate() {
                return true;
                // return this.authorize(signedInUser => signedInUser.id === this.data.user_id);
            }
        },
