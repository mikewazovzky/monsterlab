            ...
            <ul class="list-group">
                ...
                <list-item :show="show">
                    ...
                    <p>
                        ...
                        как понравившиеся (likes) и в последующем отменить их.
                        Заметки можно сортировать по количесву лайков.
                        Ссылки на понравившиеся пользователю заметки доступны в профиле (личном
                ...
                <list-item :show="show">
                    ...
                    <p>
                        ...
                        Подробное описание API находится в разделе
                ...
                <list-item :show="show">
                    ...
                    <p>
                        ...
                        другими пользователями накходящимися на сервере.
                    </p>
                </list-item>
            </ul>
        </div>
